...
Бот приемной комиссии МАИ поможет:
- Узнать информацию о поступлении
- Проверить баллы ЕГЭ
- Найти подходящие направления
- Рассказывает интересные факты о МАИ
Если ваша проблема не решена, обратитесь 
к администратору.
контакт разработчика @tayaKU21'''
